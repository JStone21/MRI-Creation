...
#----------FUNCTIONS----------
#This function checks if the script is running as an administrator
function Check-IsElevated{
    
    #Get current ID of active user
    $id = [System.Security.Principal.WindowsIdentity]::GetCurrent()

    #Get the role of the active user
    $p = New-Object System.Security.Principal.WindowsPrincipal($id)

    #If the role of the user is admin, output true. Otherwise output false.
...
#This function opens the windows folder brower and outputs a selected folder
function Get-MRIFilePath{
    
    write-host("What is the MRI file path?")
...
#----------MAIN----------
#If the active user is not running the script as an administrator, stop execution.
